    ...
    <div className="space-y-6">
      ...
      {user.publicLinksDisabledAt && (
        <div className="p-4 rounded-lg bg-rose-50 border border-rose-200 flex items-start gap-3">
          ...
          <div className="text-sm text-rose-800">
            <span className="font-semibold">Public Document Links Disabled:</span> Customer links
            (/i/*, /q/*) returning 404 since {formatDate(user.publicLinksDisabledAt)} (abuse mitigation).
          </div>
        </div>
      )}

      {/* Audited Account & Link Controls (M7-T05) */}
